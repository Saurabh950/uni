                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                echo form_dropdown("diff_abled", array('' => 'Select Differently Abled Status ', 'VISUAL HANDICAPPED' => 'VISUAL HANDICAPPED', 'ORTHO HANDICAPPED' => 'ORTHO HANDICAPPED', 'OTHER HANDICAPPED' => 'OTHER HANDICAPPED'), set_value('ph'), "class='form-control' data-plugin-selectTwo id='ph' ");
                                ?>
                                <span class="error"></span>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                echo form_dropdown("state", array('' => 'Select State', 'male' => 'Male', 'female' => 'Female', 'transgender' => 'Transgender'), set_value('state'), "class='form-control' data-plugin-selectTwo id='state' ");
                                ?>
                                <span class="error"></span>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">State Name <span class="required">*</span></label>
                                <?php
                                echo form_dropdown("present_state", array('' => 'Select State', 'male' => 'Male', 'female' => 'Female', 'transgender' => 'Transgender'), set_value('present_state'), "class='form-control' data-plugin-selectTwo id='present_state' ");
                                ?>
                                <span class="error"></span>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("select[name=diff_abled]").change(function() {
            if ($(this).val() != '') {
                $("input[name=disability_percentage]").prop('required', true).closest('div.col-md-4').show();
            } else {
                $("input[name=disability_percentage]").val('').prop('required', true).closest('div.col-md-4').hide();
            }
        });
