                ...
                <ul class="nav nav-main">
                    ...
                    <li class="<?php if ($main_menu == 'branch') echo 'nav-active';?>">
                        <a href="<?=base_url('branch')?>">
                            <i class="icons icon-directions"></i><span> College</span>
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    ?>
                    <!-- agent -->
                    <li class="nav-parent <?php if ($main_menu == 'agent') echo 'nav-expanded nav-active';?>">
                        <a>
                            <i class="far fa-edit"></i><span> Agent</span>
                        </a>
                        <ul class="nav nav-children">
                        <?php if(get_permission('agent', 'is_add')){ ?>
                            <li class="<?php if ($sub_page == 'agent/add') echo 'nav-active';?>">
                                <a href="<?=base_url('agent/add')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> Create Agent</span>
                                </a>
                            </li>
                        <?php } if(get_permission('agent', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'agent/index') echo 'nav-active';?>">
                                <a href="<?=base_url('agent/index')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> Agent List</span>
                                </a>
                            </li>
                        <?php } ?>
                        </ul>
                    ...
                    <?php
                    if (get_permission('inventory', 'is_add')) { 
                    ?>
                    <!-- inventory -->
                    <li class="nav-parent <?php if ($main_menu == 'inventory') echo 'nav-expanded nav-active';?>">
                        <a>
                            <i class="far fa-edit"></i><span> inventory</span>
                        </a>
                        <ul class="nav nav-children">
                        <?php if(get_permission('inventory', 'is_add')){ ?>
                            <li class="<?php if ($sub_page == 'inventory/add') echo 'nav-active';?>">
                                <a href="<?=base_url('inventory/add')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> Create Inventory</span>
                                </a>
                            </li>
                        <?php } if(get_permission('inventory', 'is_view')){ ?>
                            <li class="<?php if ($sub_page == 'inventory/index') echo 'nav-active';?>">
                                <a href="<?=base_url('inventory/index')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i> Inventory List</span>
                                </a>
                            </li>
                        <?php } ?>
                        </ul>
