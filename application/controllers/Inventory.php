...
class Inventory extends Admin_Controller
{
    ...
    public function add()
    {
        ...
        if (isset($_POST['save'])) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                redirect(base_url('inventory/add'));
            }
        }
        $this->data['getBranch'] = $getBranch;
        $this->data['branch_id'] = $branchID;
        $this->data['sub_page'] = 'inventory/add';
    ...
    {
        // check access permission
        if (!get_permission('inventory', 'is_view')) {
            access_denied();
        }
        ...
        $this->data['branch_id'] = $branchID;
        $this->data['title'] = 'Inventory List';
        $this->data['main_menu'] = 'inventory';
        $this->data['sub_page'] = 'inventory/view';
        $this->data['headerelements'] = array(
            'js' => array(
                'js/student.js'
            ),
