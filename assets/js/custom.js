...
function get_discipline_from_college(url) {
	...
	if (college_id != '') {
		...
		newOption[1] = new Option('GENERAL', 'GENERAL', false, false);
		newOption[2] = new Option('VOCATIONAL', 'VOCATIONAL', false, false);
		newOption[3] = new Option('HONOURS', 'HONOURS', false, false);
		onChangeSelect(newOption, 'onChangeSelect-discipline_name')
	}
	// $.ajax({
	//     url: url,
...
function get_stream_from_dis(url) {
	...
	if (discipline_id != 0) {
		var newOption = [];
		newOption[0] = new Option('Select', 0, false, false);
		newOption[1] = new Option('BACHELOR OF ARTS', 'BACHELOR OF ARTS', false, false);
		newOption[2] = new Option('BACHELOR OF COMMERCE', 'BACHELOR OF COMMERCE', false, false);
		newOption[3] = new Option('BACHELOR OF SCIENCE', 'BACHELOR OF SCIENCE', false, false);
		onChangeSelect(newOption, 'onChangeSelect-streams')
	}
}
...
function get_subject_from_stream(url) {
	...
	if (stream_id != 0) {
		...
		newOption[0] = new Option('Select', 0, false, false);
		newOption[1] = new Option('ARTS', 'ARTS', false, false);
		newOption[2] = new Option('COMMERCE', 'COMMERCE', false, false);
		newOption[3] = new Option('SCIENCE', 'SCIENCE', false, false);
		onChangeSelect(newOption, 'onChangeSelect-subject_name')
	}
}
